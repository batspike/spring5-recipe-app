...
public class RecipeBootstrap implements CommandLineRunner {
	...
	private List<Recipe> getRecipes() {
		...
		Optional<UnitOfMeasure> tableSpoonUomOpt = uomRepo.findByDescription("Tablespoon");
		...
		Optional<UnitOfMeasure> dashUomOpt = uomRepo.findByDescription("Dash");
		if(!dashUomOpt.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found!");
		}
		
		Optional<UnitOfMeasure> pintUomOpt = uomRepo.findByDescription("Pint");
		if(!pintUomOpt.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found!");
		}
		
		Optional<UnitOfMeasure> cupUomOpt = uomRepo.findByDescription("Cup");
		if(!cupUomOpt.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found!");
		}
		
		Optional<UnitOfMeasure> pinchUomOpt = uomRepo.findByDescription("Pinch");
		if(!pinchUomOpt.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found!");
		}
		
		Optional<UnitOfMeasure> ounceUomOpt = uomRepo.findByDescription("Ounce");
		if(!ounceUomOpt.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found!");
		}
        ...
        Optional<Category> mexicanCategoryOptional = categoryRepo.findByDescription("Mexican");
