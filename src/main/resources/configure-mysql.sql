...
# docker run --name mine-mysql --security-opt seccomp=unconfined -e MYSQL_ALLOW_EMPTY_PASSWORD=yes -v d:/Docker/dockerdata/mysql:/var/lib/mysql -p 3306:3306 -d mysql
